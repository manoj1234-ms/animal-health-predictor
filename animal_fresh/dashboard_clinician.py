...
with st.form("patient_intake_form"):
    ...
    with c1:
        ...
        animal_type = st.selectbox("Species", ["Dog", "Cat", "Horse", "Cow", "Pig", "Sheep", "Goat", "Chicken", "Turkey", "Duck", "Goose", "Rabbit", "Ferret", "Hamster", "Guinea Pig", "Rat", "Mouse", "Chinchilla", "Hedgehog", "Reptile (Generic)"])
        ...
        age = st.number_input("Age (Years)", 0.1, 30.0, 5.0)
    ...
    with c2:
        ...
        wbc = st.number_input("WBC (10^9/L)", 0.0, 100.0, 10.0)
        rbc = st.number_input("RBC (10^12/L)", 0.0, 15.0, 6.5)
...
if submitted:
    with st.spinner("Analyzing patient vitals..."):
        ...
        patient_data = {
            ...
            "WBC": float(wbc),
            "RBC": float(rbc),
            "Hemoglobin": 14.0, # Placeholder default
            "Platelets": 300.0, # Placeholder default
            "Glucose": 100.0,   # Placeholder default
            "ALT": 40.0,        # Placeholder default
            "AST": 40.0,        # Placeholder default
            "Urea": 25.0,       # Placeholder default
            "Creatinine": 1.0,  # Placeholder default
